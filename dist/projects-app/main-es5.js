(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminGuard = /** @class */ (function () {
                ...
                AdminGuard.prototype.canActivate = function (next, state) {
                    var admin = sessionStorage.getItem('role');
                    if (admin === 'admin') {
                        return true;
                    }
                    else {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthenticationService = /** @class */ (function () {
                ...
                AuthenticationService.prototype.signUp = function (username, email, password) {
                ...
                AuthenticationService.prototype.update = function (username, email, id) {
                    var user = {
                        username: username,
                        email: email
                    };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProjectService = /** @class */ (function () {
                ...
                ProjectService.prototype.add = function (projectName, description, location, badge) {
                ...
                ProjectService.prototype.getByBadge = function (byBadge) {
                ...
                ProjectService.prototype.deleteProject = function (deleteId) {
                    var url = _environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["APIURL"] + "/projects/remove/" + deleteId;
                    // console.log(url)
                ...
                ProjectService.prototype.editProject = function (editId, newProjectName, newDescription, newLocation, newBadge) {
                    var url = _environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["APIURL"] + "/projects/edit/" + editId;
                    // console.log(url)
                ...
                // COMMENTS SERVICES //
                ProjectService.prototype.addComment = function (comment, id) {
                    console.log({ comment: { project_id: id, content: comment } });
                    var url = _environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["APIURL"] + "/comments/comment";
                    return this.http.post(url, { comment: { project_id: id, content: comment } }, httpOptions);
                };
                ProjectService.prototype.getComments = function (id) {
                    var url = _environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["APIURL"] + "/comments/view/" + id;
                    console.log(url);
                    return this.http.get(url, httpOptions);
                };
                ProjectService.prototype.deleteComment = function (id) {
                    var url = _environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["APIURL"] + "/comments/remove/" + id;
                    console.log(url);
                    return this.http.delete(url, httpOptions);
                };
                ProjectService.prototype.updateComment = function (id, newComment) {
                    var url = _environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["APIURL"] + "/comments/edit/" + id;
                    console.log(url);
                ...
                ProjectService.prototype.removeProject = function (id) {
                    var url = _environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["APIURL"] + "/projects/adminremove/" + id;
                    console.log(url);
                    return this.http.delete(url, httpOptions);
                };
                ProjectService.prototype.removeComment = function (id) {
                    var url = _environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["APIURL"] + "/comments/adminremove/" + id;
                    console.log(url);
                    return this.http.delete(url, httpOptions);
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminComponent = /** @class */ (function () {
                function AdminComponent(projectService) {
                    this.projectService = projectService;
                    this.adminResults = [];
                }
                AdminComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.projectService.getAll().subscribe(function (response) { return _this.adminResults = response; });
                };
                AdminComponent.prototype.removeProject = function (id) {
                    console.log(id);
                    this.projectService.removeProject(id).subscribe(function (response) { return window.location.href = '/admin'; });
                };
                AdminComponent.prototype.removeComment = function (id) {
                    console.log(id);
                    this.projectService.removeComment(id).subscribe(function (response) { return window.location.href = '/admin'; });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ContactComponent = /** @class */ (function () {
                ...
                ContactComponent.prototype.onNavigate = function () {
                    window.open('https://github.com/Eli-Smith');
                };
                ContactComponent.prototype.onNavigate1 = function () {
                    window.open('https://www.linkedin.com/in/elijah-smith-092198144/');
                };
                ContactComponent.prototype.onNavigate2 = function () {
                    window.open('https://github.com/kerv91');
                };
                ContactComponent.prototype.onNavigate3 = function () {
                    window.open('https://www.linkedin.com/in/karina-rodriguez-3454a594/');
                };
                ContactComponent.prototype.onNavigate4 = function () {
                    window.open('https://github.com/jhiggins3231');
                };
                ContactComponent.prototype.onNavigate5 = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CommentsComponent = /** @class */ (function () {
                function CommentsComponent(projectsService) {
                ...
                CommentsComponent.prototype.getComments = function (id) {
                    var _this = this;
                    this.projectsService.getComments(id).subscribe(function (res) {
                        _this.commentsResponse = res;
                        _this.comments = _this.commentsResponse.comments;
                    });
                };
                ...
                ;
                CommentsComponent.prototype.addComment = function (comment, id) {
                    this.projectsService.addComment(comment, id).subscribe();
                };
                ;
                CommentsComponent.prototype.setUpdateValue = function (updateContent, updateId) {
                    this.updateContent = updateContent;
                    this.updateId = updateId;
                };
                CommentsComponent.prototype.updateComment = function (updateId, updatedComment) {
                    updatedComment = this.updateContent;
                    this.projectsService.updateComment(updateId, updatedComment).subscribe(function (response) { return window.location.href = '/gallery'; });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GalleryComponent = /** @class */ (function () {
                function GalleryComponent(projectService) {
                    this.projectService = projectService;
                    this.galleryProjects = [];
                }
                GalleryComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.projectService.getAll().subscribe(function (results) { return _this.galleryProjects = results; });
                };
                ...
                LoginComponent.prototype.signUp = function () {
                    ...
                    if (this.passwordS.value.length >= 5 && this.passwordS.value.length <= 20) {
                        this.auth.signUp(this.usernameS.value, this.email.value, this.passwordS.value)
                            ...
                            if (err.error.fields.usernameS === _this.usernameS.value) {
                                alert('Username not available');
                            }
                            else {
                                if (err.error.fields.email === _this.email.value) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DialogComponent = /** @class */ (function () {
                function DialogComponent(projectService, data) {
                    this.projectService = projectService;
                    this.data = data;
                ...
                DialogComponent.prototype.deleteProject = function (deleteId) {
                    console.log(this.data);
                ...
                ;
                DialogComponent.prototype.updateProject = function (deleteId, projectName, description, location, badge) {
                    deleteId = this.data.passedId;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProjectComponent = /** @class */ (function () {
                ...
                ProjectComponent.prototype.openDialog = function (id) {
                    var projectId = id;
                ...
                ProjectComponent.prototype.addProjects = function (projectName, description, location, badge, owner) {
                ...
                ProjectComponent.prototype.getByBadge = function (byBadge) {
                    var _this = this;
                    this.projectService.getByBadge(this.byBadge.value).subscribe(function (res) {
                        _this.dataSource = res;
                        console.log(_this.dataSource);
                    });
                };
                ProjectComponent.prototype.getByBadge1 = function (badge) {
                    var _this = this;
                    this.projectService.getByBadge(this.badge.value).subscribe(function (res) {
                        _this.dataSource = res;
                        console.log(_this.dataSource);
                    });
                };
